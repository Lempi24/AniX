...
const Home = () => {
  ...
  const slides = [
    {
      src: "https://cdn.myanimelist.net/images/anime/1768/156339l.jpg",
      title: "Super no Ura de Yani Suu Futari",
      description:
        "Ahh wakacje, czujesz ten dym z grilla prawda? Czekaj... TO PAPIEROS!",
      buttonAction: () => handleAnimeClick(62076),
    },
    {
      src: "https://cdn.myanimelist.net/images/anime/1917/158371l.jpg",
      title: "Youjo Senki II",
      description: "Mała maszyna wojenna powraca w nowym sezonie!",
      buttonAction: () => handleAnimeClick(49233),
    },
    {
      src: "https://cdn.myanimelist.net/images/anime/1615/158194l.jpg",
      title: "Grand Blue Season 3",
      description: "Szklaneczka wody? Pewnie! Dziękuję ci... O boże, o kur**",
      buttonAction: () => handleAnimeClick(62542),
    },
  ];
  return (
    <div>
